...
public class PaintEnemy : MonoBehaviour
{
    ...
    public void SplashColor()
    {
        ...
        // Create splash on the ground directly underneath paintbrush with random rotation
        var splash = Instantiate(paintSplashHolderObject, transform.position, Quaternion.Euler(0f, 0f, Random.Range(0f, 360f)));
